...
#     Dropout(0.3),  # dropout added after the 1st hidden layer
    
#     # 2nd hidden layer
#     tf.keras.layers.Dense(64, activation='relu', kernel_regularizer=l2(0.001)),
#     Dropout(0.3),  # dropout added after the 2nd hidden layer
    
#     # 3rd hidden layer
#     tf.keras.layers.Dense(32, activation='relu', kernel_regularizer=l2(0.001)),
#     Dropout(0.3),  # dropout added after the 3rd hidden layer
...
plt.tight_layout()
plt.savefig('Multilayer Perceptron - Model Loss and Accuracy Graph.png')
plt.show()